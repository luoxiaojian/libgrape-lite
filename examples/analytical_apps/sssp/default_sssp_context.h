...
#ifndef EXAMPLES_ANALYTICAL_APPS_SSSP_DEFAULT_SSSP_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_SSSP_DEFAULT_SSSP_CONTEXT_H_
...
/**
 * @brief Context for the parallel version of DefaultSSSP.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class DefaultSSSPContext : public VertexDataContext<FRAG_T, double> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit DefaultSSSPContext(const FRAG_T& fragment)
      : VertexDataContext<FRAG_T, double>(fragment, true),
        partial_result(this->data()) {}

  void Init(DefaultMessageManager& messages, oid_t source_id) {
...
#endif  // EXAMPLES_ANALYTICAL_APPS_SSSP_DEFAULT_SSSP_CONTEXT_H_
