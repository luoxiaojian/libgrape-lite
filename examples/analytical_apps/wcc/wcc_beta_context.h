...
#ifndef EXAMPLES_ANALYTICAL_APPS_WCC_WCC_BETA_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_WCC_WCC_BETA_CONTEXT_H_
...
using WCCBetaContextType = VertexDataContext<FRAG_T, typename FRAG_T::oid_t>;
 ...
 */
template <typename FRAG_T>
class WCCBetaContext : public WCCBetaContextType<FRAG_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_WCC_WCC_BETA_CONTEXT_H_
