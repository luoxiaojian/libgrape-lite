...
class TraverseMutate
    : public ParallelAppBase<FRAG_T, TraverseMutateContext<FRAG_T>>,
      public ParallelEngine {
  using edata_t = typename FRAG_T::edata_t;

 public:
  INSTALL_PARALLEL_WORKER(TraverseMutate<FRAG_T>, TraverseMutateContext<FRAG_T>,
                          FRAG_T)
