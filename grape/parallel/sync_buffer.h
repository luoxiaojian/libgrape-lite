...
class SyncBuffer : public ISyncBuffer {
 ...
 public:
  ...
  explicit SyncBuffer(VertexArrayBeta<VERTEX_SET_T, T>& data) : data_(data) {}
 ...
 private:
  VertexArrayBeta<VERTEX_SET_T, T> internal_data_;
  VertexArrayBeta<VERTEX_SET_T, T> data_;
  VertexArrayBeta<VERTEX_SET_T, bool> updated_;
  VERTEX_SET_T range_;
